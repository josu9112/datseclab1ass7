...
//		messageDisgest();
	...
	public static void readRSAKeys1() {
		try {
			...
			/* DER key */
			File derKeyFile = new File("/home/woj/temp/dses2018/lecture6/rsaprivate.der");
	...
	public static void readRSAKeys2() {
		try {
			/* PEM key */
			File pemKeyFile = new File("/home/woj/temp/dses2018/lecture6/rsaprivate.pem");
